...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'aurora': '0 8px 32px rgba(63, 140, 255, 0.15)',
        'aurora-lg': '0 12px 40px rgba(63, 140, 255, 0.2)',
      ...
      backgroundImage: {
        'aurora-gradient': 'linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 100%)',
