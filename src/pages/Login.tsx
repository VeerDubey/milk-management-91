...
const Login = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6">
      <Card className="neo-noir-card border-primary/20 shadow-2xl">
        <CardHeader className="text-center pb-8">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 neo-noir-button-accent rounded-2xl flex items-center justify-center neo-noir-glow neo-noir-float">
              <img 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 neo-noir-text-muted" />
                <Input
                  id="email"
                  type="email"
                  value={email}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 neo-noir-text-muted" />
                <Input
                  id="password"
                ...
                >
                  {showPassword ? (
                    <EyeOff className="h-4 w-4 neo-noir-text-muted" />
                  ) : (
                    <Eye className="h-4 w-4 neo-noir-text-muted" />
                  )}
                </Button>
              </div>
            </div>
