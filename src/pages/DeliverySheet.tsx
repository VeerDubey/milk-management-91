...
import { Printer, Download, FileSpreadsheet, Calendar, MapPin, Truck } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="neo-noir-text-muted">
              Generate printable delivery sheets for milk distribution
            </p>
          </div>
            ...
            <CardContent className="p-8">
              ...
              <div className="text-center mb-8">
                <div className="flex items-center justify-center gap-4 mb-4">
                  ...
                  />
                  <div>
                    <h1 className="text-2xl font-bold neo-noir-text">NAIK MILK DISTRIBUTORS</h1>
