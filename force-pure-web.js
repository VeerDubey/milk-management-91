...
console.log('🔥 FORCING PURE WEB ENVIRONMENT - Zero tolerance for Bun/Electron...');
...
// Step 3: Create minimal web-only package.json
...
fs.writeFileSync('package.json', JSON.stringify(webPackageJson, null, 2));
console.log('✅ Created pure web package.json');
...
try {
  ...
  console.log('✅ Pure web installation complete!');
} catch (error) {
  console.error('Installation failed:', error.message);
}

console.log(`
🎉 Pure web setup complete!
🚀 Run: npm run dev
📝 All electron and bun dependencies removed
